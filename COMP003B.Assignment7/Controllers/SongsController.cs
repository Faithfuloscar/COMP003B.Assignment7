...
namespace COMP003B.Assignment7.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            ViewBag.Records = from s in _context.Songs 
                              join e in _context.Records on s.SongId equals e.SongId
                              join c in _context.Artists on e.ArtistId equals c.ArtistId
                              where s.SongId == id
                              select c;
